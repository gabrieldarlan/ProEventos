...
namespace ProEventos.Application
{
    public class EventoService : IEventoService
    {
        ...
        public async Task<EventoDto> UpdateEvento(int eventoId, EventoDto model)
        {
            ...
            {
                var evento =
                    await _eventoPersist.GetEventoByIdAsync(eventoId, false);
        ...
        GetAllEventosByTemaAsync(string tema, bool includePalestrantes = false)
        {
            ...
            {
                var eventos =
                    await _eventoPersist.GetAllEventosByTemaAsync(tema, false);
                if (eventos == null) return null;
        ...
        public async Task<EventoDto>
        GetEventoByIdAsync(int eventoId, bool includePalestrantes = false)
        {
            try
            {
